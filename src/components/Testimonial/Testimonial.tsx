            ...
            <div className="container mx-auto grid grid-cols-1 gap-8 lg:gap-20 md:px-10 md:pb-10 lg:grid-cols-2">
                <div className="flex flex-col items-center mx-12 lg:mx-0">
                    <div className="relative text-center">
                        ...
                        <p className="px-6 py-1 text-lg italic">The greatest gift you can give yourself is a little bit of your own attention </p>
                    ...
                    <span className="w-12 h-1 my-2 rounded-lg dark:bg-[#F2C641]"></span>
                    <p>Soh Nelson</p>
                </div>
                <div className="flex flex-col items-center max-w-lg mx-12 lg:mx-0">
                    <div className="relative text-center">
                        ...
                        <p className="px-6 py-1 text-lg italic">Massage is the only form of physical pleasure to which nature forgot to attach consequences. </p>
